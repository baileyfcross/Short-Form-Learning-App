...
import { getFeed, getSnippet, likeSnippet, reportSnippet, saveSnippet, viewSnippetSource } from "../controllers/feedController.js";
...
feedRoutes.get("/:snippetId/source", viewSnippetSource);
